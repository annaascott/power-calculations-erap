...
# power can be set to 0.8 (80%) and two sided alpha (significance level) to 0.002 (to account for multiple testing, 0.05 divided by no of comparisons)
# hrfailp is the probability of getting outcome (example for eating disorders 0.006 or 0.6%) 

# input this into stata: stpower cox, n() power(.8) alpha(0.002) hr failp() sd()
...
# 
# .  stpower cox, n(2573717) power(.8) alpha(0.002) hr failp(0.006) sd(0.3)
# 
...
# HR is 0.90 (protective) or 1/0.9 = 1.11 for asian vs white
...
# . stpower cox, n(2421158) power(.8) alpha(0.002) hr failp(0.006) sd(0.2) 
# 
# Estimated hazard ratio for Cox PH regression
# Wald test, hazard metric
# H0: [b1, b2, ..., bp] = [0, b2, ..., bp]
...
# HR is 0.85 (protective) or 1/0.85 = 1.18
...
# . stpower cox, n(2336404) power(.8) alpha(0.002) hr failp(0.006) sd(0.2)
# 
# Estimated hazard ratio for Cox PH regression
# Wald test, hazard metric
# H0: [b1, b2, ..., bp] = [0, b2, ..., bp]
...
# stpower cox, n(2299677) power(.8) alpha(0.002) hr failp(0.006) sd(0.1)
# 
# Estimated hazard ratio for Cox PH regression
# Wald test, hazard metric
# H0: [b1, b2, ..., bp] = [0, b2, ..., bp]
...
# HR is 0.72 (protective) or 1/0.79 = 1.40

# WHITE VS ALL OTHER ETHNICITIES COMBINED


# . stpower cox, n(2825156) power(.8) alpha(0.002) hr failp(0.006) sd(0.4)
# 
# Estimated hazard ratio for Cox PH regression
# Wald test, hazard metric
# H0: [b1, b2, ..., bp] = [0, b2, ..., bp]
...
# # HR is 0.93 (protective) or 1/0.95 = 1.08
...
#    or 1.40 for 'other' ethnicity person with eczema vs white
#    or 1.08 for all other (non-white) ethnicities combined vs white
